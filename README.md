...
**P1·P2·P3 승인. P4 구현 완료**(Codex 검토 대기) — `validator/`(P2: whole-graph Validator §9,
MissionPatch §10) + `allocation/`(P3: travel §8, CBBA §11, §13 지표) + `execution/`(P4:
`SimExecutor` 2D discrete-event executor, §14 deadlock 처리). 테스트 169개 통과
...
계약 버전 v1.10 / 최신 결정 D-011. 단계 게이트 정의는
